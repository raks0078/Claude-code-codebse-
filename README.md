...
> The original unmodified source is preserved in the [`backup` branch](https://github.com/raks0078/Claude-code-codebse-/tree/backup).
...
```bash
git clone https://github.com/raks0078/Claude-code-codebse-.git ~/claude-code \
...
```bash
# 1. Clone the repo
git clone https://github.com/raks0078/Claude-code-codebse-.git
cd claude-code/mcp-server
...
This repository contains source code from Anthropic's Claude Code, made publicly available on **2026-03-31**. All original source code is the property of [Anthropic](https://www.anthropic.com).
